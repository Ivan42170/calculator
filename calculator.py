...
def equality() :
    ...
    res = act([first_number, second_number])
    if res == "" :
        pass
    elif res == int(res) :
        res = int(res)
    entry_text.set(str(res))
...
b_minus = Button(text="-", width=10, height=4, bg = '#ffeda7', activebackground = '#fcf600', command = lambda : operation(minus))
b_dot = Button(text="*", width=10, height=4, bg = '#ffeda7', activebackground = '#fcf600', command = lambda : operation(mul))
b_div = Button(text=":", width=10, height=4, bg = '#ffeda7', activebackground = '#fcf600', command = lambda : operation(div))
...
b_mul = Button(text=',', width=10, height=4, bg = '#f98d27', activebackground ='#f94427', command = point)
...
b_div.place(x=left_space+button_width*3, y=top_space+button_height*1)

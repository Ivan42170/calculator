...
b0 = Button(text="0", width=10, height=4, activebackground = '#0f62fb', bg = '#bdfdfb')
#b0 = Button(text="0", width=10, height=4, activebackground='red', bg = '#cacaca', command=lambda x: )
b1 = Button(text="1", width=10, height=4, activebackground = '#0f62fb', bg = '#bdfdfb')
b2 = Button(text="2", width=10, height=4, activebackground = '#0f62fb', bg = '#bdfdfb')
b3 = Button(text="3", width=10, height=4, activebackground = '#0f62fb', bg = '#bdfdfb')
b4 = Button(text="4", width=10, height=4, activebackground = '#0f62fb', bg = '#bdfdfb')
b5 = Button(text="5", width=10, height=4, activebackground = '#0f62fb', bg = '#bdfdfb')
b6 = Button(text="6", width=10, height=4, activebackground = '#0f62fb', bg = '#bdfdfb')
b7 = Button(text="7", width=10, height=4, activebackground = '#0f62fb', bg = '#bdfdfb')
b8 = Button(text="8", width=10, height=4, activebackground = '#0f62fb', bg = '#bdfdfb')
b9 = Button(text="9", width=10, height=4, activebackground = '#0f62fb', bg = '#bdfdfb')
b_plus = Button(text="+", width=10, height=4, bg = '#ffeda7', activebackground = '#fcf600')
b_minus = Button(text="-", width=10, height=4, bg = '#ffeda7', activebackground = '#fcf600')
b_dot = Button(text="*", width=10, height=4, bg = '#ffeda7', activebackground = '#fcf600')
b_dif = Button(text=":", width=10, height=4, bg = '#ffeda7', activebackground = '#fcf600')
b_del = Button(text="CE", width=10, height=4, bg = '#0feba3', activebackground = '#15d300')
b_eq = Button(text="=", width=10, height=4, bg = '#0feba3', activebackground = '#15d300')
b_sing = Button(text="+/-", width=10, height=4, bg = '#f98d27', activebackground = '#f94427')
b_mul = Button(text=',', width=10, height=4, bg = '#f98d27', activebackground ='#f94427')
